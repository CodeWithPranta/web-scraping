...
CHAT_IDS = ["6369309742", "7536947314","1500641135", "7157931070"]  # Add as many IDs as needed
...
def fetch_data():
    encoded_api_from_vfs = b'aHR0cHM6Ly9hcGkuc2NoZW5nZW52aXNhYXBwb2ludG1lbnRzLmNvbS9hcGkvdmlzYS1saXN0Lw=='
    api = base64.b64decode(encoded_api_from_vfs).decode('utf-8')
    try:
